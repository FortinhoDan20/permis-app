...
const ListPartner = () => {
  return (
    ...
    <NavLink to="/new-partner">
      <button href="/add" className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white float-end mt-2 mx-3 py-2" >
    ...
    <div className="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      ...
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Liste des Associés</h2>
